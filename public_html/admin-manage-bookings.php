...
<link rel="stylesheet" type="text/css" href="css/table-admin-style.css" />
...
{				?>		
						  <tr>
							...
							<td><a href="admin-update-package.php?pid=<?php echo htmlentities($result->pid);?>"><?php echo htmlentities($result->pckname);?></a></td>
...
<?php if($result->status==2)
{
	?><td>Cancelled</td>
<?php } else {?>
<td><a href="admin-manage-bookings.php?bkid=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('Do you really want to cancel booking')" >Cancel</a> / <a href="admin-manage-bookings.php?bckid=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('booking has been confirm')" >Confirm</a></td>
<?php }?>
...
<!--COPY rights end here-->
  ...
  <!--//content-inner-->
		<!--/sidebar-menu-->
						<?php include('admin-sidebarmenu.php');?>
							  <div class="clearfix"></div>		
							</div>
							<script>
							var toggle = true;
