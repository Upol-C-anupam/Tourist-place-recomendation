  ...
  <div class="grid-form1">
  	       <h3>Update Page Data</h3>
  	         ...
  	         <div class="tab-content">
                  ...
                  <option value="admin-manage-pages.php?type=terms">terms and condition</option>
                  <option value="admin-manage-pages.php?type=privacy">privacy and policy</option>
                  <option value="admin-manage-pages.php?type=aboutus">aboutus</option>
                  <option value="admin-manage-pages.php?type=contact">Contact us</option>
                </select>
									</div>
								</div>
<div class="form-group">
